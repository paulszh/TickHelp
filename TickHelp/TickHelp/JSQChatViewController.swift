...
//            }
            ...
            SweetAlert().showAlert("What would you like to do?", subTitle: "nil",
                    style: AlertStyle.Warning,
                    buttonTitle:"Add Friend", buttonColor:UIColor.redColor(),
                    otherButtonTitle:  "Thumbs up!", otherButtonColor: UIColor.grayColor()) { (isOtherButton) -> Void in
